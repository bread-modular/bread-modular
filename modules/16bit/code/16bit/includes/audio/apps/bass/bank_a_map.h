...
// tools/sim_bass.cpp asserts this contract in testBankAMapping().

#include <cstdint>

#include "audio/apps/bass/bass_dsp.h"

namespace bass_bank_a {
...
// Lowest cutoff norm the knob reaches. Below ~0.25 (~140 Hz on BassDsp's
...
inline bool apply(BassDsp& dsp, uint8_t cc, uint8_t value) {
